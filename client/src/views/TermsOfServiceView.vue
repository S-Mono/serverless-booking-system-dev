    ...
    <div class="terms-container">
        ...
        <div class="terms-content">
            ...
            <section>
                ...
                <p>
                    本規約は、ヘアーサロン
                    ジョイス(以下「当店」または「当社」といいます)が提供する予約サービス(以下「本サービス」といいます)の利用に関する条件を、本サービスを利用するすべてのお客様(以下「ユーザー」といいます)と当社との間で定めるものです。
                </p>
            </section>
            ...
            <section>
                <h2>第12条(退会)</h2>
                <ol>
                    <li>ユーザーは、所定の退会手続により、本サービスから退会することができます。</li>
                    <li>退会手続を行うと、以下の処理が実行されます：
                        <ul>
                            <li>本サービスとLINEの連携が解除され、退会したことがLINEヤフー株式会社に通知されます</li>
                            <li>アカウント情報および予約履歴等のユーザーデータが削除されます</li>
                            <li>予約中の予約がある場合は自動的にキャンセル扱いとなります</li>
                            <li>この操作は取り消すことができません</li>
                        </ul>
                    </li>
                    <li>退会後も、法令に基づき保存が必要な情報については、当社が定める期間保管することがあります。</li>
                </ol>
            </section>
            ...
            <section>
                ...
                <p>
                    ユーザーは、当社の書面による事前の承諪なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。
                </p>
            </section>
